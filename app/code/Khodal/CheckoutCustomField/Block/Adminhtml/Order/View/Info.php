 ...
 */
namespace Khodal\CheckoutCustomField\Block\Adminhtml\Order\View;
...
class Info extends \Magento\Sales\Block\Adminhtml\Order\AbstractOrder
{
     ...
     * @return void
     */
    public function getPostNumberValue()
    {
        $orderId = $this->getRequest()->getParam('order_id');
        $order = $this->orderFactory->create()->load($orderId);
        $shippingAddress = $order->getShippingAddress(); // You can also use getBillingAddress()
        return $shippingAddress->getPostNumber();
    }
    /**
     * Get VAT Number
     *
     * @return void
     */
    public function getVatNumberValue()
    {
        $orderId = $this->getRequest()->getParam('order_id');
        $order = $this->orderFactory->create()->load($orderId);
        $shippingAddress = $order->getShippingAddress(); // You can also use getBillingAddress()
